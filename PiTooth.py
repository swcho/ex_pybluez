...
class Bluetooth:
  ...
  def __init__(self):
    ...
    # ref: http://www.question-defense.com/tools/class-of-device-bluetooth-cod-list-in-binary-and-hex
    os.system("hciconfig hci0 class 0x002540")
    os.system("hciconfig hci0 name HID\ Emulator")
  ...
  def __init__(self):
    ...
    while have_dev == False:
      try:
        ...
        self.dev = InputDevice("/dev/input/event10")
        have_dev = True
      except OSError:
